...
# create a second and third list of strings
approved_vendors = ["cisco", "juniper", "big_ip"]
banned_vendors = ["huawei", "michaelsoft", "booz"]
...
for x in banned_vendors:
    print("\nThis is a very serious matter," + x + " is a terrorist organization, and the police are on their way!", end="")
